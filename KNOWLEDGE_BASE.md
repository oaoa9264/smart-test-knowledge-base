...
| POST | `/api/product-docs/suggest-update` | 基于风险澄清生成文档更新建议 | `{product_doc_id, risk_item_id, clarification_text}` | ProductDocUpdateRead (201) |
...
- 当前前端页面已覆盖文档导入、详情查看、分块编辑、更新记录审核；`suggest-update` 更偏向与风险澄清流程或外部调用串联
